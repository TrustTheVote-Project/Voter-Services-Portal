  ...
  context 'specific registration' do
    ...
    describe 'absentee_status_history' do
      it 'should return success', :vcr do
        ...
        expect(response.body).to eq("{\"success\":true,\"items\":[{\"request\":\"Absentee Request\",\"action\":\"Receive\",\"date\":\"10 Oct 2012\",\"registrar\":\"\",\"notes\":\"\"},{\"request\":\"Absentee Request\",\"action\":\"Approve\",\"date\":\"10 Oct 2012\",\"registrar\":\"York County General Registrar Clerk 17\",\"notes\":\"\"},{\"request\":\"Absentee Request\",\"action\":\"Reject\",\"date\":\"10 Oct 2012\",\"registrar\":\"York County General Registrar Clerk 17\",\"notes\":\"Unsigned\"},{\"request\":\"Absentee Ballot\",\"action\":\"Receive\",\"date\":\"10 Oct 2012\",\"registrar\":\"\",\"notes\":\"\"},{\"request\":\"Absentee Ballot\",\"action\":\"Approve\",\"date\":\"10 Oct 2012\",\"registrar\":\"York County General Registrar Clerk 17\",\"notes\":\"\"},{\"request\":\"Absentee Ballot\",\"action\":\"Reject\",\"date\":\"10 Oct 2012\",\"registrar\":\"York County General Registrar Clerk 17\",\"notes\":\"Previous Absentee Ballot\"}]}")
      end
